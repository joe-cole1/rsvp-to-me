...
export function PasswordGate({ slug }: { slug: string }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0a0f", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px", fontFamily: "inherit" }}>
      <div style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "20px", padding: "32px 28px", width: "100%", maxWidth: "360px", color: "#fff" }}>
        <div style={{ fontSize: "32px", textAlign: "center", marginBottom: "16px" }}>🔒</div>
        <h1 style={{ fontSize: "20px", fontWeight: 700, textAlign: "center", marginBottom: "8px" }}>Private Event</h1>
